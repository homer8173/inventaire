...
/**
 *  \file       htdocs/core/modules/fichinter/mod_plaisance.php
 *  \ingroup    fiche intervention
 *  \brief      File with Pacific numbering module for interventions
 */

dol_include_once( '/inventaire/core/modules/inventaire/modules_inventaire.php');
/**
 *	Class to manage numbering of intervention cards with rule Pacific.
 */
class mod_plaisance extends ModeleNumRefInventaire
{
