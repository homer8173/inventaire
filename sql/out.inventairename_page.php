...
/**
 *   	\file       dev/Inventairenames/Inventairename_page.php
...
dol_include_once('/module/class/inventairename.class.php');
...
if ($action == 'list' || empty($id))
{
    ...
    $sql.= " FROM ".MAIN_DB_PREFIX."inventaire_name as t";
